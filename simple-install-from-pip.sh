...
#
# Usage:
#   ./simple-install-from-pip.sh                        # keep current settings, auto-detect .env
#   ./simple-install-from-pip.sh /path/to/.env          # explicit .env path
#   RLM_HOST=0.0.0.0 ./simple-install-from-pip.sh       # custom bind host
#   RLM_PORT=3000 ./simple-install-from-pip.sh          # custom port
#   RLM_NO_ENV=1 ./simple-install-from-pip.sh           # start the service without any .env file
